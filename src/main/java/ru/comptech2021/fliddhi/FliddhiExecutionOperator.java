...
public class FliddhiExecutionOperator
    ...
    public FliddhiExecutionOperator(SiddhiManager siddhiManager, String sql) {
        ...
        siddhiAppRuntime.start(); //todo where is shutdown?
    ...
    private Event record2Event(StreamRecord<Row> record) { return null; } //todo

    private StreamRecord<Row> event2Record(Event event) { return null; } //todo перенести в StreamSchema
}